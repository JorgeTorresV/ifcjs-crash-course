...
const preselectMat = new MeshLambertMaterial({
    transparent: true,
    opacity: 0.6,
    color: 0xffff88, //0xff88ff,
    depthTest: false
})

const verde = new MeshLambertMaterial({
    transparent: true,
    opacity: 0.6,
    color: 0x00ff88, //0xff88ff,
    depthTest: false
})
...
function highlight2(event, material, model, multiple = false) {
    const found = cast(event)[0];
    if (found) {
...
window.onclick = (event) => highlight2(event, selectMat, selectModel);
